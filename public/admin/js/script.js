...
// const tablePermissions=document.querySelector("[table-parmissions]");
// if(tablePermissions) {
//   const buttonSubmit=document.querySelector("[button-submit]");
//   buttonSubmit.addEventListener("click",()=>{
//     const roles=[];
//     const listElementRoleId=tablePermissions.querySelectorAll("[role-id]");
//     for(const elements of listElementRoleId){
//       const roleId=elements.getAttribute("role-id");
//       const role={
//         id: roleId,
//         permissions: []
//       }
...
//       roles.push(role);
//     }
//     const path=buttonSubmit.getAttribute("button-submin");
//     fetch(path,{
//       method: "PATCH",
//       headers: {
//         "Content-Type": "application/json",
